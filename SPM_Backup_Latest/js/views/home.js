...
export async function renderHome() {
    ...
    return `
        ...
        <div class="section container reels-home-container" style="position: relative; z-index: 10; padding-top: 40px; padding-bottom: 60px;">
            <div class="text-center" style="margin-bottom: 40px;">
                <h2 class="spm-retro-3d-text" style="font-size: clamp(2.5rem, 4vw, 3.5rem);">India's First - Animated Academic Videos</h2>
            </div>
