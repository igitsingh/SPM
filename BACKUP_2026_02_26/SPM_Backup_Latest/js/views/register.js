...
export const renderRegister = () => {
    // Logic is handled by hydrateViews() -> hydrateRegister() in interactions.js
    ...
    <div class="spm-login-container" style="
        ...
        padding: 20px;
    ">
        <div class="spm-card" style="width: 100%; max-width: 500px; padding: 40px; text-align: center; background: white; border-radius: 12px; box-shadow: 0 5px 20px rgba(0,0,0,0.1);">
            <div style="margin-bottom: 20px; font-size: 3rem;">📝</div>
            <h2 style="margin-bottom: 10px; color: var(--text-primary, #333); font-family: var(--font-main, sans-serif);">Partner Registration</h2>
            <p style="margin-bottom: 30px; color: var(--text-secondary, #666);">Join our network of book sellers</p>
            
            <form id="registerForm" style="display: flex; flex-direction: column; gap: 15px; text-align: left;">
            ...
            <div style="margin-top: 20px; font-size: 0.9em; color: var(--text-secondary, #666);">
                Already have an account? <a href="#/login" style="color: var(--primary, #FF7B00); text-decoration: none; font-weight: 500;">Login here</a>
            </div>
        </div>
    </div>
    `;
