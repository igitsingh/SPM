    ...
    return `
                ...
                <div class="container">
                    ...
                    <div class="leadership-grid">
                        <div class="leader-card animate-fade-up" style="animation-delay: 0.1s;">
                            <div class="leader-img-wrap drop-glow-frame">
                                <div class="leader-img-inner">
                                    <img src="./assets/images/lekhraj_singh_professional.png" alt="Lekhraj Singh">
                                </div>
                                <div class="leader-blur-glow"></div>
                            </div>
        ...
        <style>
            ...
            .leader-img-inner {
                ...
                inset: 3px;
                z-index: 2;
                border-radius: 21px; /* inset minus margin */
                overflow: hidden;
                background: #e2e8f0;
            }
            .leader-img-inner img {
                width: 100%;
                height: 100%;
                object-fit: cover;
                transition: transform 0.6s ease-out;
            ...
            /* Hover Interactions */
            .leader-card:hover .drop-glow-frame {
                transform: translateY(-8px);
                box-shadow: 0 30px 50px rgba(0,0,0,0.3);
            }
            .leader-card:hover .leader-img-inner img { 
                transform: scale(1.03); 
            }
            .leader-card:hover .leader-blur-glow {
                top: 0%;
                left: 10%;
                background: #0ea5e9; /* Shifts to a premium blue glow on hover */
                opacity: 1;
                width: 80%;
                height: 80%;
            }
